...
class CucumberJava8ClassVisitor extends JavaIsoVisitor<ExecutionContext> {
     ...
     * comes back unattributed; {@code null} where the new method returns {@code void} or a type Cucumber declares.
     */
    ...
    /**
     * Copy the return type over onto the method the template just added, which is the one statement of the class that
     * was not there before it was applied.
     */
